...
- (void)initializeControl {
    ...
    CGSize BFStepperButton = CGSizeMake(23, self.frame.size.height);
    ...
    self.textField.frame = CGRectMake(BFStepperButton.width, (BFStepperButton.height - sizeField.height)/2,self.frame.size.width - (BFStepperButton.width*2), sizeField.height);
...
-(void) setTypeChange:(TextStepperFieldChangeKind)pTypeChange
{
    ...
    [self.delegate changeNumber:self.textField.text];
}
